...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        self.outCT = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size, out_channels=1)
        self.outSeg = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size, out_channels=8)
