...
from monai.losses import ContrastiveLoss, DiceCELoss, DiceLoss, SSIMLoss
...
class swinUNETR(LightningModule):
    def __init__(self, SWIN_size,
        ...
        self.DSCE_Loss = DiceCELoss(to_onehot_y=False, include_background=False, softmax=True, smooth_dr=1e-6, smooth_nr=1e-4)
